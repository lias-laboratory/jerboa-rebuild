...
\end{figure}
La dernière étape d'appariement du PN\textsubscript{35} est l'application
...
\begin{figure}[htb!]
	\begin{subfigure}{0.5\linewidth}
		\centering
		\includegraphics[width=.5\textwidth]{cs2-6-evaluation-colourFaceRed}
		\caption{}
	...
	\begin{subfigure}{.5\linewidth}
		\centering
		\includegraphics[width=.5\textwidth]{cs2-7-reevaluation-colourFaceBlue}
		\caption{}
	...
	\begin{subfigure}{.49\textwidth}
		\centering
		\includegraphics[scale=.45]{cs2-evaluationTree-4}
		\caption{}
	...
	\begin{subfigure}{.49\textwidth}
		\centering
		\includegraphics[scale=.45]{cs2-pn12-dag-reeval}
		\caption{}
...
\subsubsection*{Ajout de scission}
...
\subsubsection*{Annulation d'évènements}
...
\begin{figure}[htb!]
	\centering
	\includegraphics[scale=.455]{cs2-pn57-dag-reeval}
\end{figure}
