...
public class ExtrudeIndependentFace extends JerboaRuleGenerated {
    ...
    public ExtrudeIndependentFace(RawDynaOrTrackModeler modeler) throws JerboaException {
        ...
        JerboaRuleNode rn3 = new JerboaRuleNode("n3", 3, JerboaOrbit.orbit(-1,2), 3, new ExtrudeIndependentFaceExprRn3pos());
...
;
    ...
    private class ExtrudeIndependentFaceExprRn3pos implements JerboaRuleExpression {
