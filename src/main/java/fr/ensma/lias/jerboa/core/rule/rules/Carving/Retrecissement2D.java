...
public class Retrecissement2D extends JerboaRebuiltRule {
    ...
    public Retrecissement2D(ModelerGenerated modeler) throws JerboaException {

        super(modeler, "Retrecissement2D", "Carving");
...
;
    ...
    public JerboaRuleResult applyRule(JerboaGMap gmap, JerboaDart n6) throws JerboaException {
