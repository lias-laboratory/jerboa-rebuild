...
public class JerboaLongTaskWait implements ActionListener {
	...
	public JerboaLongTaskWait() {
		...
		horiz.setMaximumSize(new Dimension(200, 50));

		System.out.println(horiz.getSize());
	...
	/**
	 * Cette fonction est la fonction qui faut appeler. Son role est d'ouvrir la boite de dialog et
	 * de faire une attente via le verrou connu.
	 * 
	 * @return
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		// et je libere un slot de mon verrou
