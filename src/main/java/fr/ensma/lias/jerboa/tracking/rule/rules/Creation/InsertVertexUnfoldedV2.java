...
public class InsertVertexUnfoldedV2 extends JerboaRuleGenerated {
    ...
    public InsertVertexUnfoldedV2(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "InsertVertexUnfoldedV2", "Creation");
        ...
        JerboaRuleNode rn3 = new JerboaRuleNode("n3", 3, JerboaOrbit.orbit(1), 3, new InsertVertexUnfoldedV2ExprRn3pos());
        right.add(rn0);
        right.add(rn1);
        right.add(rn2);
        right.add(rn3);
...
;
    ...
    private class InsertVertexUnfoldedV2ExprRn3pos implements JerboaRuleExpression {
...
Vec3 res = new Vec3();
res.barycenter(gmap.<fr.ensma.lias.jerboa.embeddings.Vec3>collect(curleftPattern.getNode(0),JerboaOrbit.orbit(0),0));
return res;
