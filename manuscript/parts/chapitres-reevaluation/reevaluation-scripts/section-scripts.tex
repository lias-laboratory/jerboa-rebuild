...
Une première hypothèse est de représenter un script uniquement par ses entrées
et ses sorties, c'est-à-dire selon le modèle de représentation de boîte fermée
(ou \textit{black box} en anglais). %
...
Cependant, en faisant choix, les scripts doivent procéder à l'enregistrement des
