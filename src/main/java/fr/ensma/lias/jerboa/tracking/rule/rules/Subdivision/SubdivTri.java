package fr.ensma.lias.jerboa.tracking.rule.rules.Subdivision;
...
public class SubdivTri extends JerboaRuleGenerated {
    ...
    public SubdivTri(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "SubdivTri", "Subdivision");
        ...
        JerboaRuleNode rn2 = new JerboaRuleNode("n2", 2, JerboaOrbit.orbit(1,2,-1,3), 3, new SubdivTriExprRn2pos());
        right.add(rn0);
        right.add(rn1);
        right.add(rn2);
        rn0.setAlpha(1, rn1);
...
;
    ...
    private class SubdivTriExprRn2pos implements JerboaRuleExpression {
