...
Au cours de cette année, j'ai passé des entretiens pour doctorats, mais aussi
...
\begin{itemize}
  ...
  \item l'implantation d'un mécanisme de réévaluation~\cite{gaide2023model,
		gaide2024reevaluation}, comprenant la création d'identifiants
...
Un article est en cours de soumission \cite{gaide2024reevaluation}. %
