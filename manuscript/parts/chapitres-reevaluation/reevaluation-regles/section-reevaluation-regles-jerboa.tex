...
\maxime{J'ai tenté quelque chose, mais je ne suis pas sûr que ce soit le bon
	endroit pour ça.} \xavier{Je ne comprends pas ta phrase "j'ai tenté quelque chose" : de quoi parles-tu ?}
 \xavier{Et à propos de la dernière stratégie, il faut préciser si elle est actuellement réalisable ou si c'est une variante qui reste à l'état d'idée.}%
...
permet de prévenir le risque d'un appariement erroné d'orbites et de produire des
...
d'une autre \xavier{Pas très clair, le fait qu'une orbite sommet puisse "discriminer" une face $\rightarrow$ comment ?}, ne correspond pas à une origine de face scindée par la règle de
triangulation. %
...
scission, voire de fusion. \xavier{Pourquoi "voire" de fusion ? Supprimer un événement peut annuler n'importe quel autre événement postérieur, en théorie.}%
...
\xavier{Il manque une conclusion à ce chapitre...}
