	...
	\only<2->{%
		\begin{columns}
					...
					\begin{onlyenv}<3->
						\begin{myblock}
							\begin{itemize}
								...
								\item<4-> préservation de n0
								\item<5-> création de n2
								\item<6-> création de n1
								\item<8-> orbite \onslide<9->{complète}
								\item<10> orbite incomplète
							\end{itemize}
						\end{myblock}
					\end{onlyenv}
					% }
			...
			\begin{column}{.7\textwidth}
				...
				\includegraphics<7>[height=.8\textheight]{triangulation-application-n1-n2}%
				\includegraphics<8-9>[height=.8\textheight]{triangulation-application-3D-notion-orbite}%
				\includegraphics<10>[height=.8\textheight]{triangulation-application-3D-notion-orbite-incomplete}%
			\end{column}
		\end{columns}
	}
\end{frame}
