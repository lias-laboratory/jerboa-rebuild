...
public class TriangulateSquareFaceFull extends JerboaRuleGenerated {
    ...
    public TriangulateSquareFaceFull(RawDynaOrTrackModeler modeler) throws JerboaException {
