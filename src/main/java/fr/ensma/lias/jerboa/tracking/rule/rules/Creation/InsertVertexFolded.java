...
public class InsertVertexFolded extends JerboaRuleGenerated {
    ...
    public InsertVertexFolded(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "InsertVertexFolded", "Creation");
        ...
        JerboaRuleNode rn1 = new JerboaRuleNode("n1", 1, JerboaOrbit.orbit(1,2,3), 3, new InsertVertexFoldedExprRn1pos());
        right.add(rn0);
        right.add(rn1);
        rn0.setAlpha(0, rn1);
;
    ...
    private class InsertVertexFoldedExprRn1pos implements JerboaRuleExpression {
