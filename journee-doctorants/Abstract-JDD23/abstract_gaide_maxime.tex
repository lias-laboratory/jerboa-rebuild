...
\begin{figure}[h!]
  \begin{minipage}[c]{.49\textwidth}
    ...
    \caption{\footnotesize{\textbf{Règle de triangulation composée de deux
          membre. Son membre gauche, filtre une face
          % $\langle \alpha 0, \alpha 1 \rangle$ composée des brins atteignables
          % par des liaisons $\alpha 0$ (en) ou $\alpha 1$ (en rouge),
          et son
          membre droit la scinde.}}}
...
\normalsize{Par exemple, dans la règle de triangulation en
  ...
  pour la réévaluation de modèles. L'étape suivante portera sur son intégration
