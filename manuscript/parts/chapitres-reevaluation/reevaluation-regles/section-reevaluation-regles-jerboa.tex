...
l'étape d'appariement et terminer la réévaluation sans erreur. %
...
Par exemple, dans le cas d'étude nº~2, l'opération de chanfrein n'est pas
réévaluée (figures~\ref{fig:reevaluation-base-regles-cs2-4-evaluation-chamfer}
et \ref{fig:reevaluation-base-regles-cs2-reevaluation}
page~\pageref{fig:reevaluation-base-regles-cs2-reevaluation}). %
\todo{reprendre ici}
