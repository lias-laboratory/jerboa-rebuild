...
public class ExtrudeFaceEdgeXAxis extends JerboaRuleGenerated {
    ...
    public ExtrudeFaceEdgeXAxis(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "ExtrudeFaceEdgeXAxis", "Extrusion");
        ...
        JerboaRuleNode rn4 = new JerboaRuleNode("n4", 4, JerboaOrbit.orbit(0), 3, new ExtrudeFaceEdgeXAxisExprRn4pos());
        right.add(rn0);
        right.add(rn1);
        right.add(rn2);
        right.add(rn3);
...
;
    ...
    private class ExtrudeFaceEdgeXAxisExprRn4pos implements JerboaRuleExpression {
