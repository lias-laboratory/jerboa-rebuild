package fr.ensma.lias.jerboa.tracking.rule.rules.UnSew;
...
public class UnSewA3 extends JerboaRuleGenerated {
    ...
    public UnSewA3(RawDynaOrTrackModeler modeler) throws JerboaException {
