...
public class RainureDouble2D extends JerboaRuleGenerated {
    ...
    public RainureDouble2D(ModelerGenerated modeler) throws JerboaException {

        super(modeler, "RainureDouble2D", "Carving");
