...
In this section, we present the generalized maps, graph transformation rules and their subsequent concepts which are necessary for understanding our contribution.
...
G-maps include conditions that ensure the consistency of objects; for example, two faces are always linked along an edge.
...
which guarantee the preservation of the consistency of G-maps.
...
Rules contain the necessary information characterizing the to\-po\-lo\-gi\-cal changes
affecting an orbit throughout an application. %
Thus, the tracking of an orbit is %made automatic 
automatically made
...
and its ap\-pli\-ca\-tion on $H$'s dart $33$ (Fig.~\ref{fig:demo-fig-triangulation-left-match}). %
