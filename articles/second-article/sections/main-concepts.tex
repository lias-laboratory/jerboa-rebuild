...
\begin{figure}[t]
  ...
  \begin{subfigure}[t]{.45\columnwidth}
    \centering
    \includegraphics[height=.25\textheight]{figures/demo-fig-triangulation-left-match.pdf}
    \caption{Graph $G$}
  ...
  \begin{subfigure}[t]{.45\columnwidth}
    \centering
    \includegraphics[height=.25\textheight]{figures/demo-fig-triangulation-right-match.pdf}
    \caption{Graph $H$}
