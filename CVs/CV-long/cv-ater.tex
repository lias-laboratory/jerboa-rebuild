...
\noindent Situation actuelle : Doctorant en troisième année; contrat doctoral avec enseignement \\
\noindent Financement : Bourse Ministère
...
\noindent Thématique de recherche : Modélisation géométrique à base topologique
...
Dans cette partie se trouve la description de mon parcours universitaire jusqu'au début de ma formation doctorale.
...
\subsection{Recherche de formation doctorale (2020-2021)}
Au cours de cette année, j'ai passé des entretiens pour des thèses de doctorat, mais aussi
pour des postes en entreprise.
...
\subsection{Algorithmique et programmation; 1ère année ISAE-ENSMA; 27h~TP,
	45h~Projet, 3h~TD}

Ces compétences sont enseignées avec le langage \textbf{Ada}. %
...
J'ai encadré des séances de TP, de Projet (étalé sur 3 séances) et
quelques TDs. %
J'ai également pu surveiller des sessions de contrôle continu. %

\subsection{Conception Logicielle; 1ère année ISAE-ENSMA; 42h~TP}
Ces compétences sont enseignées avec le langage \textbf{Ada}. %
Les étudiants apprennent à concevoir des programmes en respectant différents
concepts tels que la ré-utilisabilité et la maintenabilité du code. %
Ils apprennent également à développer des programmes en utilisant les concepts
de généricité et de polymorphisme. %
J'ai encadré exclusivement des séances de TP. %

\subsection{Analyses de données; 1ère année ISAE-ENSMA; 6h~TP}
Les compétences liées à l'analyse de données sont enseignées avec le langage
\textbf{Python} et s'appuie sur l'utilisation de notebooks. %
L'objectif est de donner aux étudiants les clés pour traiter déduire des
connaissances grâce à l'étude de jeux de données. %
Les étudiants apprennent à utiliser différents outils (dans un environnement
\textbf{Python}) tels que \textbf{Pandas}, \textbf{Numpy}, \textbf{SQL} pour
exploiter des jeux de données et, entre autre, les visualiser
(\textbf{Seaborn}). %
J'ai pu encadrer des séances de TP et corriger des TPs.

\subsection{Apprentissage Automatique; 2ème année ISAE-ENSMA; 3h~TP}
Les compétences liées à l'apprentissage automatique avec le langage
\textbf{Python} et s'appuie sur l'utilisation de notebooks Jupyter. %
L'objectif est de proposer une introduction à l'apprentissage automatique par la
pratique. %
...
\subsection{Algorithmique et Programmation 1~; Licence 1 Info 18h~TP; 6hTD}
Ces compétences sont enseignées avec le langage \textbf{OCaml}. %
Les étudiants apprennent les bases de la programmation en commençant par
représenter différentes informations avec des types de données et à les
organiser en structures de données. %
Ils apprennent aussi à écrire des instructions de programmation, sous forme
de séquences puis de fonctions pour traiter les données. %
...
\begin{center}
	\begin{tabular}{|p{2.5cm}|l|l|l|l|l|}
		...
		\hline
		Université
		\par de Poitiers                   & Algorithmique et Programmation 1        & L1 Info      & 6h                                   & 18h &        \\
		\hline
		\multicolumn{3}{|l|}{Total HETD~:} & \multicolumn{3}{l|}{144~h}                                                                                   \\
		\hline
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{|l|l|l|}
		...
		\hline
		OCaml                & introduction à la programmation             & L1 info      \\
...
Dans cette section se trouve les descriptions des différentes responsabilités
que j'ai prises en tant qu'étudiant ou dans le cadre d'un emploi. %

\subsection{Étudiant Élu au Conseil du Département Informatique et Interaction,
	Aix-Marseille Université (L2-L3, 2016-2018)}
...
J'ai été élu par les autres doctorants pour les
représenter aux conseils de l'ED MIMME.

\subsection{Surveillance d'examen, IFASUD, Toulon, (Juin 2021)}{
	J'ai été employé par IFASUD pour surveiller des sessions d'examen niveau BTS. %
}

\subsection{Encadrement EUR - Conception d'une interface pour le rejeu et
	animation spatio-temporelle de modèle}
L'Université de Poitiers propose un parcours EUR pour son master
informatique. %
Ce parcours a deux objectifs : premièrement, offrir aux étudiants du master
une expérience de recherche au sein d'une équipe sur un véritable sujet de
recherche~; deuxièmement, offrir à des doctorants une expérience
d'encadrement. %
Les tâches confiées à cet étudiant concernent le développement d'une interface
utilisateur pour l'édition et la réévaluation d'une spécification paramétrique
et l'intégration de la dimension pour l'animation spatio-temporelle de
modèles. %
La deuxième partie de ces travaux s'appuie sur la thèse de Chiara
Stefani~\cite{stefani2010}. %
À l'issue de cet encadrement, l'étudiant doit rédiger un rapport, concevoir un
poster et présenter son travail. %

\subsection{Encadrement d'un stage facultatif de M1 - Annotation
	spatio-temporelle de bâtiments archéologiques}
Ce stage a été réalisé dans la continuité du projet EUR et a impliqué deux
étudiants. %
Deux tâches leur ont été confiées, l'une concerne l'extension de l'interface
graphique avec l'intégration de stratégies pour moduler la réévaluation d'un
objet selon les intentions d'un utilisateur~; la deuxième concerne la conception
d'un système d'annotations temporelles des opérations de modélisation dans le
cadre de la modélisation spatio-temporelle. %
La première tâche s'appuie sur les travaux publiés
dans~\cite{gaide2024reevaluation}. %
La deuxième tâche s'appuie sur les travaux de Chiara Stefani~\cite{stefani2010}.


\section{Recherche}

Cette section fait, dans un premier temps, la description de mes premières
expériences de recherche (stages, projets étudiants), puis, dans un second
temps, des travaux effectués, présentés et publiés dans le cadre de ma formation
doctorale. %
...
Elle fait suite aux travaux d'Anaïs Cardot~\cite{cardot2019}.
...
\subsubsection{Objectifs et plan}

L'objectif de cette thèse est de permettre la génération rapide de variantes à partir
d'un modèle initial. %
Afin de permettre la réévaluation de modèles, les objectifs suivants ont été définis~:
\begin{itemize}
...
\end{itemize}
À ce jour, les tâches réalisées sont~:
\begin{itemize}
	\item la détection automatique de l'ensemble des changements
	      topologiques~\cite{gaide2023automatic} appliquée à un modèle par une
	      règle Jerboa,
	\item l'implantation d'un mécanisme de réévaluation~\cite{gaide2023model,
		      gaide2024reevaluation, gaide2024reevaluationfr}, comprenant la création d'identifiants
	      persistants et de spécifications paramétriques, pour les règles Jerboa.
\end{itemize}
Les études en cours sont~:
\begin{itemize}
	\item le support des scripts règles pour la réévaluation,
	\item l'animation de l'évolution d'un modèle au cours du temps.
\end{itemize}

\subsubsection{Analyses syntaxiques de règles de transformations de graphe}
...
Deux méthodes sont généralement utilisées pour déterminer l'impact d'une
...
Le coût en temps est négligeable, mais le risque et d'introduire des
informations erronées sans pour autant délimiter précisément le périmètre
d'application de l'opération sur le modèle. %
...
Ces travaux ont été présentés~\cite{gaide2023detection} puis publiés
\cite{gaide2023automatic}. %

\subsubsection{Réévaluation de modèle à partir de règles de transformation de graphe}
...
Ces travaux ont été présentés~\cite{gaide2023model, gaide2024reevaluationfr}
puis publiés~\cite{gaide2024reevaluation}. %

\subsubsection{Exploitation des scripts de règles pour la réévaluation de modèles}
...
\printbibliography[keyword={own}, title={Mes travaux}]
\printbibliography[notkeyword={own},title={Références}]

% \section{Motivations pour un poste d'ATER à l'Université de Poitiers}

% %% D'abord, qui je suis
% Ayant suivi un cursus Licence Master en informatique à Aix-Marseille Université,
% je suis actuellement doctorant à l'ISAE-ENSMA et rattaché aux laboratoires LIAS
% et XLIM.

% %% Ce que j'ai déjà fait
% %%% Enseignement
% Au cours de mon doctorat, ayant pour objectif de poursuivre une carrière
% académique, il m'a été permis d'avoir une activité d'enseignement en complément
% de mon activité de recherche. %
% J'ai ainsi pu encadrer des étudiants découvrant les bases de la programmation et
% de la conception logicielle à l'ISAE-ENSMA. %

% %%% Encadrement et prise de responsabilité collective
% Toujours dans le même but, et ayant apprécié le face à face pédagogique avec des
% étudiants, j'ai également pris la responsabilité d'encadrer un étudiant de
% Master 1 EUR découvrant la recherche en informatique à l'Université de
% Poitiers. \\%

% %% Ma capacité d'adaptation pour l'enseignement à l'université
% Bien que mes enseignements s'inscrivent dans une formation d'ingénieur, je suis
% déjà coutumier de l'environnement universitaire par mon propre cursus. %
% Ainsi, j'ai conscience des difficultés que les étudiants peuvent rencontrer et
% suis à même de les accompagner. %
% En complément, j'ai suivi une formation à la pédagogie et suis capable de
% m'adapter aux attentes des étudiants. %
% %% Ma capacité d'adaptation dans une équipe pédagogique
% Avec mes expériences d'enseignement et d'encadrement, j'ai aussi pris
% consciences des contraintes pouvant exister au sein d'une équipe pédagogique et
% suis en mesure de m'adapter à des changements d'emploi du temps et faire des
% remplacements lorsque nécessaire. \\%

% %% Les enseignements qui m'intéressent
% En vue de m'intégrer au mieux au sein de l'équipe pédagogique de l'Université de
% Poitiers, j'ai pris contacte avec celle-ci et me suis renseigné sur les
% compétences et outils qu'elle enseigne. %
% Les enseignements en algorithmique et programmation en langage C et OCaml, ainsi
% que la programmation orienté objet en Java, m'intéresse particulièrement. %
% Enseignements pour lesquels je suis d'ores et déjà opérationnel. %
% %% Les enseignements que je peux *aussi* faire
% La base de données et les technologies du web sont aussi des enseignements pour
% lesquels je suis disposé à m'investir. %
% Néanmoins, et à ce jour, n'étant immédiatement opérationnel pour ceux-ci, un
% investissement plus conséquent me sera nécessaire pour les préparer. \\%

% %% Mes intérêts immédiats au poste d'ATER
% Au travers de cette candidature, je souhaite prendre position pour un poste
% d'Attaché Temporaire d'Enseignement et de Recherche et poursuivre une activité
% d'enseignement au sein de l'Université de Poitiers. %
% %%% Boucler mes publications
% Cela me permettrait, d'une part, de finaliser et publier mes travaux en vue de
% les soutenir d'ici décembre 2024. %
% %%% Diversifier mon dossier d'enseignements
% D'autre part, cela me permettrait de diversifier mes enseignements, notamment
% auprès d'un autre public, à savoir des étudiants inscrits dans un cursus
% universitaire. %
