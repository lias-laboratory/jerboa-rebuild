...
public class UnsewA2Folded extends JerboaRebuiltRule {
    ...
    public UnsewA2Folded(ModelerGenerated modeler) throws JerboaException {

        super(modeler, "UnsewA2Folded", "UnSew");
