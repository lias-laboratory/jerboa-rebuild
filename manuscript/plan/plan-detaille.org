...
** Des DAGs pour représenter l'histoire d'une cellule topologique
...
** Des DAGs pour retrouver les paramètres topologiques lors de la réévaluation
...
** Réévaluer des scripts de règles pour générer des modèles complexes
