...
**** réévaluation (nommage persistant entre autre) : kripac, capoyleas, chen, mun…
...
**** Le nommage persistant : un problème historique de la modélisation paramétrique
***** Les systèmes de nommage existants
***** Les usages du nommage persistant
