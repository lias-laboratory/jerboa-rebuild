...
\begin{frame}[fragile]
	\begin{onlyenv}<1>
		...
		\begin{minipage}[t][.4\textheight][t]{\textwidth}
			\begin{myblock}
				\centering
				\includegraphics[height=40pt]{rule-edge-collapse-no-color}
				\tcblower
				\begin{lstlisting}[style=script-style,language=jerboa-script,escapechar=\%]
				...
				\begin{column}{.5\textwidth} % TOP RIGHT
					...
					\begin{minipage}[t][.3\textheight][t]{.8\columnwidth}
						...
						\begin{myblock}
							\raggedright\tiny\ttfamily
							1-creationCarre()\\
							2-subdivisionQuad(\pndart{0}{1n2})\\
							3-S\_triangulationCC(\pndart{0}{1n2;2n0})\\
							{ \indentrule } For \textlangle{}0,1\textrangle{} in \textlangle{}0,1,2\textrangle{}(\pndart{0}{1n2;2n0})\\
							{ \indentrule } { \indentrule } 1-triangulation(\pndart{2}{1n2;2n0})\\
							{ \indentrule } { \indentrule } 2-triangulation(\pndart{4}{1n4;2n0})\\
							{ \indentrule } { \indentrule } 3-triangulation(\pndart{6}{1n6;2n0})\\
							{ \indentrule } { \indentrule } 4-triangulation(\pndart{0}{1n0;2n0})
							4-coloration(\pndart{3}{1n2;2n0};3\{1n0\})
						\end{myblock}
					\end{minipage}
				\end{column}
			\end{columns}
	...
	\begin{onlyenv}<2>
		...
		\begin{minipage}[t][.4\textheight][t]{\textwidth}
			\begin{columns}
				...
				\begin{column}{.45\textwidth}
					\centering
					\textbf{then~: triangulation + face duale}\\[5pt]
				...
				\begin{column}{.45\textwidth}
					\centering
					\textbf{else~: insertion face + faces duales}\\[5pt]
