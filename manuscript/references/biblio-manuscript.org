...
|   | modeleur/noyau                | entreprise               | URL | année |
|---+-------------------------------+--------------------------+-----+-------|
|   | ACIS                          | Dassault Systèmes        |     |       |
|   | CGAL                          | opensource               |     |       |
|   | Convergence Geometric Modeler | Dassault Systèmes        |     |       |
|   | Open CASCADE                  | opensource               |     |       |
|   | Parasolid                     | Siemens                  |     |       |
|   | ShapeManager                  | Autodesk (ACIS fork)     |     |       |
...
|  2 | Collaborative intelligent CAD framework incorporating design history tracking algorithm                                            | H.Lee     |     |  2010 | reevaluation (tracking) |
