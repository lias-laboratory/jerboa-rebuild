...
public class ExtrudeVolumeFaceZAxis extends JerboaRuleGenerated {
    ...
    public ExtrudeVolumeFaceZAxis(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "ExtrudeVolumeFaceZAxis", "Extrusion");
        ...
        JerboaRuleNode rn4 = new JerboaRuleNode("n4", 4, JerboaOrbit.orbit(-1,2), 3, new ExtrudeVolumeFaceZAxisExprRn4pos());
...
;
    ...
    private class ExtrudeVolumeFaceZAxisExprRn4pos implements JerboaRuleExpression {
