...
return face4;\end{lstlisting}
	...
	\end{onlyenv}
	\begin{onlyenv}<3>
		\frametitle<3>{Séquence~: représentation ouverte}
	...
	\begin{onlyenv}<3>
		...
		\begin{minipage}[t][.3\textheight][t]{\textwidth} % TOP
			...
			\begin{columns}
				\begin{column}{.5\textwidth} % TOP LEFT
					\centering
					\includegraphics[width=.3\columnwidth]{boucle-exemple-reval-triangle} % graphe de script
					\includegraphics[width=.3\columnwidth]{boucle-exemple-reval-triangle-quad} % graphe de script
					\includegraphics[width=.3\columnwidth]{boucle-exemple-edit} % graphe de script
				\end{column}
				\begin{column}{.5\textwidth} % TOP RIGHT
					\centering
					\begin{minipage}[t][.3\textheight][t]{.8\columnwidth}
