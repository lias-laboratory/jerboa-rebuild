...
expérience de recherche au sein d'une équipe sur un véritable sujet de
...
Cours qui m'intéressent
\begin{itemize}
	\item Algo Prog -> OCaml (à réchauffer), C (opérationnel),
	\item POO -> Java (opérationnel), UML (à réchauffer), Patrons (à réchauffer)
	\item BDD -> à réchauffer, ça fait longtemps que j'ai pas fait, SQL ça fait longtemps aussi
	\item techno web -> jamais trop fait, mais ça peut se gérer
\end{itemize}
