...
\titlegraphic{%
  \begin{figure}
    \includegraphics[height=20pt]{lias-logo}%
    \hfill
    \includegraphics[height=20pt]{Logo_ISAE-ENSMA}%
    \hfill
    \includegraphics[height=20pt]{cgvc-logo}%
    \hfill
    \includegraphics[height=20pt]{Logo_up}%
    \hfill
    \includegraphics[height=20pt]{xlim-logo}%
  \end{figure}
}
  ...
  \begin{columns}
    ...
    \begin{column}{.49\textwidth}
      \begin{block}{\onslide<5>{Orbit of type}}
        \begin{itemize}
          \item<1-> Face \alt<5>{{\color{red}$\orbit{0,1}$}$(a)$}{$\orbit{0,1}(a)$}%
          \item<2-> Edge \alt<5>{{\color{red}$\orbit{0,2}$}$(a)$}{$\orbit{0,2}(a)$}%
          \item<3-> Edge \alt<5>{{\color{red}$\orbit{0,2}$}$(c)$}{$\orbit{0,2}(c)$}%
          \item<4-> Vertex \alt<5>{{\color{red}$\orbit{1,2}$}$(a)$}{$\orbit{0,2}(a)$}%
          \item<5-> Face edge {\color{red}$\orbit{0}$}$(a)$%
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
  \begin{block}{}<1->
    Sub-graph of type \alt<5>{{\color{red}$\orbit{o}$}}{$\orbit{o}$} incident to a dart.
  \end{block}
\end{frame}
