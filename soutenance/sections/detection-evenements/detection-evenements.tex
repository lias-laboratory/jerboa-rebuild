...
\begin{frame}{Scission d'une arête $\orbit{0,2}$ par les liaisons explicites~: orbite complète}
	...
	\includegraphics<1>[height=.9\textheight]{evenement-scission-expl-arete-1.pdf}%
	\includegraphics<2>[height=.9\textheight]{evenement-scission-expl-arete-2.pdf}%
	\includegraphics<3>[height=.9\textheight]{evenement-scission-expl-arete-3.pdf}%
	\includegraphics<4>[height=.9\textheight]{evenement-scission-expl-arete-4.pdf}%
\end{frame}
...
\begin{frame}{Scission d'un sommet $\orbit{1,2}$ par les liaisons explicites~: orbite incomplète}
	...
	\includegraphics<1>[height=.9\textheight]{false-positive-scission-sommet-1}%
	\includegraphics<2>[height=.9\textheight]{false-positive-scission-sommet-2}%
	\includegraphics<3>[height=.9\textheight]{false-positive-scission-sommet-3}%
	\includegraphics<4>[height=.9\textheight]{false-positive-scission-sommet-4}%
\end{frame}
