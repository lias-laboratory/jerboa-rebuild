...
\(L\orbit{1,2}(n_{2})\). %
Nous devons alors de compléter la notion d'origine à l'aide d'un contexte qui
...
\end{figure}
Ce contexte, que nous ajoutons aux origines, nous permet de faire le lien entre
