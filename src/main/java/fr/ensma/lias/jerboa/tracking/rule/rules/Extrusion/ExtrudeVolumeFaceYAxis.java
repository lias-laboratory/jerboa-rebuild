...
public class ExtrudeVolumeFaceYAxis extends JerboaRuleGenerated {
    ...
    public ExtrudeVolumeFaceYAxis(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "ExtrudeVolumeFaceYAxis", "Extrusion");
        ...
        JerboaRuleNode rn4 = new JerboaRuleNode("n4", 4, JerboaOrbit.orbit(-1,2), 3, new ExtrudeVolumeFaceYAxisExprRn4pos());
...
;
    ...
    private class ExtrudeVolumeFaceYAxisExprRn4pos implements JerboaRuleExpression {
