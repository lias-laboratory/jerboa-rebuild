...
Tout d'abord développés pour conception et la fabrication de pièces
...
vidéos~\cite{autodesk3ds,autodeskMaya,blenderSculpting}, mais aussi ceux de
...
bâtiments~\cite{muller2006procedural, haegler2009procedural,
  Quattrini_Baleani_2015} ou des villes~\cite{parish2001procedural,
  esri2023cityengine}, voire des mondes entiers pour le cinéma et le jeu
...
construit par les applications successives d'opération aussi appelé
...
Pour le grand public, ces outils offrent aussi la possibilité de concevoir des
...
Dans certains cas ces besoins se concrétisent la modélisation d'objets de
...
c'est-à-dire génériques en toutes dimensions. %
...
Pour alléger cette difficulté, les logiciels de modélisation paramétrique
...
d'une nouvelle représentation géométrique à partir d'un modèle paramétrique
initial. %

%% introduction du problème de la nomination persistante
Dès les années 90, la réévaluation de modèle paramétrique fait l'objet de
...
Aujourd'hui, plusieurs solutions existent pour effectuer un tel suivi, néanmoins
celles-ci se heurtent à limitation concernant la construction des opérations de
modélisation. %
Celle-ci sont construites suivant un langage de code dont l'analyse est
...
directement dans le code d'une opération de modélisation. %
...
survenir. %
En effet, le risque d'introduire des erreurs et ainsi conduire à des erreurs de
...
et le suivi des volumes et autres entités de plus hautes dimensions et plus
particulièrement dans le cadre de la réévaluation. %
...
Les utilisateurs ne peuvent donc pas éditer le processus constructif avec
...
être analysés puis réparés le cas échéant afin d'être utilisables. %
