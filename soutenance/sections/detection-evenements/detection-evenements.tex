...
\begin{frame}{Autres évènements}
  \begin{columns}
	...
	\includegraphics<1>[width=\columnwidth]{triangulation-application-3D-deletion}
	\includegraphics<2>[width=\columnwidth]{triangulation-application-3D-merging}
	\includegraphics<3>[width=\columnwidth]{triangulation-application-3D-notion-nomodif}
	\includegraphics<4>[width=\columnwidth]{triangulation-application-3D-origines-modification}
	\end{column}
  \end{columns}
\end{frame}
