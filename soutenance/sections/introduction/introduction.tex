\begin{frame}
	...
	\begin{tikzpicture}
		\node (img1) at (current page.north west)[] {\includegraphics[width=3cm]{example-image-a}};
		\node (img2) at (img1.south east)[] {\includegraphics[width=3cm]{example-image-b}};
		\node (img3) at (img2.north east)[] {\includegraphics[width=3cm]{example-image-c}};
	\end{tikzpicture}
...
\begin{frame}
	...
	\begin{itemize}
		\item<1-> Objectifs~:
		      \onslide<1->%
		      \begin{itemize}
			      \item Rejeu de processus constructifs~;
			      \item Édition étendue (ajout, suppression et déplacement d'opérations)
		      \end{itemize}
