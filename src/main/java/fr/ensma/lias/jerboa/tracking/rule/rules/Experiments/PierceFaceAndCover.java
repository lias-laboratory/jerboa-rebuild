...
public class PierceFaceAndCover extends JerboaRuleGenerated {
    ...
    public PierceFaceAndCover(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "PierceFaceAndCover", "Experiments");
