...
public class ExtrudeFaceEdge extends JerboaRuleGenerated {
    ...
    public ExtrudeFaceEdge(JerboaRebuilt modeler) throws JerboaException {
        ...
        // -------- RIGHT GRAPH
        JerboaRuleNode rn0 = new JerboaRuleNode("n0", 0, JerboaOrbit.orbit(0), 3, new ExtrudeFaceEdgeExprRn0vertexTracker());
        ...
        JerboaRuleNode rn4 = new JerboaRuleNode("n4", 4, JerboaOrbit.orbit(0), 3, new ExtrudeFaceEdgeExprRn4pos(), new ExtrudeFaceEdgeExprRn4vertexTracker());
        right.add(rn0);
        right.add(rn1);
        right.add(rn2);
        right.add(rn3);
