...
déterminée par l'étiquette du n\oe ud \(n_{0}\) affichée en {\color{myvividorange}jaune} dans la
...
et \(1\)-arcs implicites, à droite en \textcolor{myvividorange}{jaune}, sont des
réécritures d'un \(0\)-arc implicite dans le n\oe ud d'accroche, à gauche aussi
en \textcolor{myvividorange}{jaune}. %
%
\begin{figure}[htb!]
	\centering
	\includegraphics[scale=.45]{pn35-dag-eval-step-2}
	\caption{Étape 2 \texttt{[1n3;2n4;{\color{myvividorange}5n0}]} de la construction du DAG}
...
\(\orbit{0}\) (l'orbite encadrée en {\color{myvividorange}jaune}), toutes deux
...
\begin{figure}[htb!]
	...
	\caption{Étape 3 \texttt{[1n3;{\color{myvividorange}2n4};5n0]} de la construction du DAG}
...
et le brin (encadré en {\color{myvividorange}jaune}) sont créés \textit{ex nihilo} par
...
\begin{figure}[htb!]
	...
	\caption{Étape 4 \texttt{[{\color{myvividorange}1n3};2n4;5n0]} de la construction du DAG}
...
{\color{myvividorange}jaune} dans la
