...
\begin{frame}{Jerboa graph transformation rules : Application}
  \begin{figure}
    ...
    \includegraphics<7>[height=.85\textheight]{implicit-links}%
    \includegraphics<8>[height=.85\textheight]{explicit-links}%

    % \includegraphics<5>[height=.85\textheight]{application-4-expl}%
    % \includegraphics<6>[height=.85\textheight]{application-5-darts}%
    \includegraphics<9>[height=.85\textheight]{application-5-impl}%
  \end{figure}
\end{frame}

\begin{frame}{Jerboa graph transformation rules : \alt<1>{Orbit}{Complete orbit}}
  \begin{figure}
    \centering
    \includegraphics<1>[height=.85\textheight]{application-orbit}%
    \includegraphics<2>[height=.85\textheight]{application-complete}%
  \end{figure}
\end{frame}
