...
public class ExtrudeVolumeFaceXAxis extends JerboaRuleGenerated {
    ...
    public ExtrudeVolumeFaceXAxis(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "ExtrudeVolumeFaceXAxis", "Extrusion");
        ...
        JerboaRuleNode rn4 = new JerboaRuleNode("n4", 4, JerboaOrbit.orbit(-1,2), 3, new ExtrudeVolumeFaceXAxisExprRn4pos());
        JerboaRuleNode rn5 = new JerboaRuleNode("n5", 5, JerboaOrbit.orbit(0,-1), 3);
        JerboaRuleNode rn6 = new JerboaRuleNode("n6", 6, JerboaOrbit.orbit(0,1), 3);
        right.add(rn0);
        right.add(rn1);
        right.add(rn2);
        right.add(rn3);
...
;
    ...
    private class ExtrudeVolumeFaceXAxisExprRn4pos implements JerboaRuleExpression {
...
return curleftPattern.getNode(0).<fr.ensma.lias.jerboa.embeddings.Vec3>ebd(0).addn(1,0,0);
