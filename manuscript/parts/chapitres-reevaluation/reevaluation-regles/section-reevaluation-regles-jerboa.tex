...
\begin{figure}[htb!]
	\centering
	\includegraphics[width = .19\textwidth]{8-reevaluation-color}
...
mais il est tout à fait possible de définir ce que nous appelons des stratégies
pour définir des comportements de réévaluation qui correspondent aux intentions
de modélisation des utilisateurs. %
...
Les DAGs de réévaluation représentent l'ensemble des évolutions qui impactent,
voir qui auraient dû impacter, l'évolution d'une orbite au cours de la
réévaluation. %
À l'aide des informations qu'ils contiennent, il est possible de définir des
stratégies pour adapter le comportement du mécanisme de réévaluation selon les
préférences des utilisateurs. %
Nous présentons \todo{reprendre ici}
