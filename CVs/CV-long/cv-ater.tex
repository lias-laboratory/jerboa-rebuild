...
\subsection{Surveillance d'examen pour une entreprise de formation, Toulon, (Juin 2021)}{
	J'ai été employé par une entreprise afin de surveiller des sessions d'examen. %
}
...
\begin{itemize}
	\item la détection automatique~\cite{gaide2023automatic} de l'ensemble des
	      changements topologiques appliquée à un modèle par une règle Jerboa,
