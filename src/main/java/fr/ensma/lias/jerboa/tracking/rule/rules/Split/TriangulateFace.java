...
public class TriangulateFace extends JerboaRuleGenerated {
    ...
    public TriangulateFace(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "TriangulateFace", "Split");
        ...
        JerboaRuleNode rn2 = new JerboaRuleNode("n2", 2, JerboaOrbit.orbit(1,2,3), 3, new TriangulateFaceExprRn2pos());
        right.add(rn0);
        right.add(rn1);
        right.add(rn2);
        rn0.setAlpha(1, rn1);
...
;
    ...
    private class TriangulateFaceExprRn2pos implements JerboaRuleExpression {
