...
Or, dans la réévaluation cette application est supprimée est l'arête n'est pas
créée. %
Comme illustré dans la
figure~\ref{fig:reevaluation-base-regles-reevaluation-appariement-cas2-pn57}, la
conséquence de cette suppression d'application est que la face à colorier n'est
pas re-créée. %
...
L'une des face, le long de cette arête est ensuite coloriée en rouge par
...
Dans l'hypothèse ou les deux faces sont transformées dans l'évaluation initiale,
