package fr.ensma.lias.jerboa.tracking.rule.rules.Modif;
...
public class EdgeFlip extends JerboaRuleGenerated {
    ...
    public EdgeFlip(RawDynaOrTrackModeler modeler) throws JerboaException {
