...
public class SpecEditorLauncher {
	...
	public static void main(String[] args) throws JerboaException {
		...
		SEPanel sePanel = new SEPanel(gmapviewer, bridge, modeler);
		
		BorderLayout borderlayout = new BorderLayout();
		frame.getContentPane().setLayout(borderlayout);
		
		frame.getContentPane().add(sePanel, BorderLayout.WEST);
		frame.getContentPane().add(gmapviewer, BorderLayout.CENTER);
