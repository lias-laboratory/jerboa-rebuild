...
d'identifier de manière robuste une orbite. %
...
opérations ayant affecté une orbite. %
...
Et enfin, nous avons défini les caractéristique de la structure de données à
