\begin{frame}
	...
	\begin{tikzpicture}
		\node (img1) at (current page.north west)[] {\includegraphics[width=5cm]{revit-modeling-interior}};
		\node (img2) at (img1.south east)[] {\includegraphics[width=6cm]{furniture-3D-modelling}};
		\node (img3) at (img2.north east)[] {\includegraphics[width=5cm]{blender_render}};
	\end{tikzpicture}
