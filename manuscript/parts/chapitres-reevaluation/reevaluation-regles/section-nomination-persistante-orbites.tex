...
\begin{figure}[htb!]
	\begin{minipage}{.25\textwidth}
		\begin{subfigure}{\textwidth}
			\centering
			\includegraphics[width=\textwidth]{sc1-path-to-collapse-origin}
			\caption{}
...
enregistré par l'application jusqu'au n\oe ud d'accroche (voir le chemin en {\color{orange}orange} dans la figure~\ref{fig:reevaluation-base-regle-nomination-persistante-orbites-chemin-regle-contraction}). %
