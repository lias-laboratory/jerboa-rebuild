...
public class InsertVertex extends JerboaRebuiltRule {
    ...
    public InsertVertex(ModelerGenerated modeler) throws JerboaException {

        super(modeler, "InsertVertex", "Creation");
