...
| 17 | The Parametric Casting Process Modeling Method Based on the Topological Entities Naming                    | Liu       |     |  2018 | à lire |
| 18 | Persistent naming based on graph transformation rules to reevaluate parametric specification               | Cardot    |     |  2019 |        |
| 19 | A Lineage-Based Referencing DSL for Computer-Aided Design                                                  | Cascaval  |     |  2023 | lu     |
| 20 | Reevaluation in rule-based graph transformation modeling systems                                           | Gaide     |     |  2024 |        |
| 21 | A persistent naming discrimination method based on the sweeping direction                                  | Dai       |     |  2024 | lu     |
|----+------------------------------------------------------------------------------------------------------------+-----------+-----+-------+--------|
#+TBLFM: $1=(@#-1)
...
#+STARTUP: shrink
|---+-------+----------------+-----+-------+-----------|
| 0 | titre | premier auteur | URL | année | mots-clés |
|---+-------+----------------+-----+-------+-----------|
|---+-------+----------------+-----+-------+-----------|
#+TBLFM: $1=(@#-1)
