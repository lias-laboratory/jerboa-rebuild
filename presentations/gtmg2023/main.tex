  ...
  \begin{columns}
    \begin{column}{.49\textwidth}
      \begin{figure}
        ...
        \includegraphics<4>[height=.6\textheight]{house-0-cell-n.pdf}%
...
\begin{frame}{Règles de transformation de graphe Jerboa : Application}
  \begin{figure}
    ...
    \includegraphics<6>[height=.8\textheight]{transformation-animation-7-left-match.pdf}%
...
\begin{frame}{Création de quatre arêtes $\orbit{\alpha 0, \alpha 2}$}
  ...
  \begin{figure}
    \begin{subfigure}{.45\textwidth}
      \centering
      \includegraphics[height=.6\textheight]{demo-fig-left-1.pdf}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.45\textwidth}
      \centering
