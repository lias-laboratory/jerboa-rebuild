...
\subsection{Mise à jour d'un DAG d'évaluation}
...
appliquer une autre stratégie de réévaluation. %
...
directement de l'édition d'une spécification paramétrique et plus
particulièrement de l'ajout et la suppression d'opérations. %

\subsubsection*{Ajout de scission}

Un premier exemple de réévaluation avec l'ajout d'une opération a été présenté
la section précédente avec le DAG de réévaluation du PN\textsubscript{35}
(figure~\ref{fig:reevaluation-base-regle-reevaluation-pn35}). %
Plus particulièrement, cet exemple illustre la création d'une branche pour
chacune des entités issues d'une scission provoquée par une opération ajoutée
dans l'édition d'une spécification paramétrique. %
Chacune de ces branches nous permet alors de suivre l'évolution de ces
orbites. %
La première stratégie que nous proposons permet aux utilisateurs de choisir
parmi toutes ces branches lesquelles ils souhaitent suivre ou interrompre. %
Pour cela, ils peuvent définir une stratégie par défaut, par exemple, réévaluer
toutes les branches, ou bien réévaluer que la branche principale. %
Au cours de la réévaluation, ils peuvent également refaire un choix et
l'enregistrer dès qu'une nouvelle scission est ajoutée. %

\subsubsection*{Annulation et suppression d'évènement}
...
\begin{figure}[htb!]
	\begin{subfigure}{.4\textwidth}
		\centering
		\includegraphics[scale=.455]{cs2-evaluationTree-4}
	\end{subfigure}
