package fr.ensma.lias.jerboa.tracking.rule.rules.Sew;
...
public class SewA3 extends JerboaRuleGenerated {
    ...
    public SewA3(RawDynaOrTrackModeler modeler) throws JerboaException {
