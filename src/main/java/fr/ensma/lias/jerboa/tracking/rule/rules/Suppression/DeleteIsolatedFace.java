...
public class DeleteIsolatedFace extends JerboaRuleGenerated {
    ...
    public DeleteIsolatedFace(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "DeleteIsolatedFace", "Suppression");
