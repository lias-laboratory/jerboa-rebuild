...
\david{bizarre que ce qui suit soit dans cette section sur les chemins. C'est plutôt un résumé/conclusion de la section 3. Je le mettrais donc plutôt dans un 3.3 Résumé, par exemple}\maxime{Oui, j'ai peut-être pris la consigne "faire comme dans la présentation" de manière trop littérale. Cela dit même si ça ne m'a pas semblé superflu, je voudrais bien ton avis, j'ai pas non plus envie que le manuscrit soit trop lourd à lire} %
