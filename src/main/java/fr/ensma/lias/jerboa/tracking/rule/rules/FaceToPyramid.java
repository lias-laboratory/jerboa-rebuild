...
public class FaceToPyramid extends JerboaRuleGenerated {
    ...
    public FaceToPyramid(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "FaceToPyramid", "");
        ...
        JerboaRuleNode rn1 = new JerboaRuleNode("n1", 1, JerboaOrbit.orbit(1,2), 3, new FaceToPyramidExprRn1color(), new FaceToPyramidExprRn1pos());
...
;
    ...
    private class FaceToPyramidExprRn1color implements JerboaRuleExpression {
...
// ======== END CODE TRANSLATION FOR EXPRESSION COMPUTATION
    ...
    private class FaceToPyramidExprRn1pos implements JerboaRuleExpression {
