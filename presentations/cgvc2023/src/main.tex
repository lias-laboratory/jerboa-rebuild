...
\date{Computer Graphics and Visual Computing 14$^{th}$ September 2023}
...
\titlegraphic{%
  \begin{figure}
    \includegraphics[height=25pt]{lias-logo.png}%
    \hfill
    \includegraphics[height=25pt]{Logo_ISAE-ENSMA.pdf}%
    \hfill
    \includegraphics[height=25pt]{Logo-up.pdf}%
    \hfill
    \includegraphics[height=25pt]{xlim-logo.png}%
  \end{figure}
}
...
\begin{frame}{Introduction}
  \begin{figure}
    ...
    \hspace*{2em}
    \includegraphics<2>[height=.35\textheight]{icosahedron-catmull-clark01}%
    \includegraphics<3->[height=.35\textheight]{icosahedron-catmull-clark01-coloriage-2}%
  \end{figure}
  \begin{itemize}
    \item Dynamic computing
    \item Cost in relation to object's complexity
  \end{itemize}
  \onslide<4>{
  Topological events tracked in:
    \begin{itemize}
      \item <4> Modelers' APIs
      \item <4> Persistent naming in parametric systems
      \item <4> Optimization of geometric operations
    \end{itemize}
    }
\end{frame}
...
\begin{frame}{Introduction}
  \begin{itemize}
    ...
    \item Method :
    \begin{itemize}
      \item Formalizing the objects : generalized maps
      \item Formalizing the operations : Jerboa's graph transformation rules
    \end{itemize}
  \end{itemize}
\end{frame}
    ...
    \begin{columns}
      ...
      \begin{column}{.49\textwidth}
        \begin{block}<2->{Decomposition of an object in :}
          \begin{itemize}
            \item<2-> Faces separated with $2$-links ({\color{mediumblue} —})%
            \item<3-> Edges separated with $1$-links ({\color{red} —})%
            \item<4> Vertices separated with $0$-links ({\color{black} —})%
          \end{itemize}
        \end{block}
      \end{column}
    \end{columns}
  \end{figure}
  \begin{block}{A generalized map (G-map)}<4>
    A graph whose vertices are called \emph{darts} and arcs are called \emph{links}.
  \end{block}
\end{frame}

\begin{frame}{Orbits}
  \begin{block}{An orbit}<1->
    A G-map's sub-graph of type $\orbit{o}$ incident to a dart.
  \end{block}
  \begin{columns}
    \begin{column}{.49\textwidth}
      \begin{figure}
...
\begin{frame}{Jerboa's graph transformation rules : Application}
  \begin{figure}
    \centering
...
\begin{frame}{Jerboa's graph transformation rules : Orbit}
  \begin{figure}
    \centering
...
\begin{frame}{Conclusion}
  \begin{itemize}
    \item<1-> Conclusions
      \begin{itemize}
        \item<1-> Entirely automatic orbit tracking
        \begin{itemize}
          \item<2-> No code addition within modeling operations
        \end{itemize}
        \item<2-> Pre-computed static or localized dynamic detection
      \end{itemize}
  \end{itemize}
\end{frame}
