...
public class ExtrudeFaceEdgeYAxis extends JerboaRuleGenerated {
    ...
    public ExtrudeFaceEdgeYAxis(RawDynaOrTrackModeler modeler) throws JerboaException {

        super(modeler, "ExtrudeFaceEdgeYAxis", "Extrusion");
        ...
        JerboaRuleNode rn4 = new JerboaRuleNode("n4", 4, JerboaOrbit.orbit(0), 3, new ExtrudeFaceEdgeYAxisExprRn4pos());
        right.add(rn0);
        right.add(rn1);
        right.add(rn2);
        right.add(rn3);
...
;
    ...
    private class ExtrudeFaceEdgeYAxisExprRn4pos implements JerboaRuleExpression {
