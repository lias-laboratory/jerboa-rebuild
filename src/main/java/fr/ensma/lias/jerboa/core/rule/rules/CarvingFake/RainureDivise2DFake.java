...
public class RainureDivise2DFake extends JerboaRebuiltRule {
    ...
    public RainureDivise2DFake(ModelerGenerated modeler) throws JerboaException {

        super(modeler, "RainureDivise2DFake", "CarvingFake");
...
;
    ...
    public JerboaRuleResult applyRule(JerboaGMap gmap, JerboaDart n0, JerboaDart n1, Object fakeLeft) throws JerboaException {
