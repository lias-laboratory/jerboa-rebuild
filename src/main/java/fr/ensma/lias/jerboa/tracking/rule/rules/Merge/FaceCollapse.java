...
public class FaceCollapse extends JerboaRuleGenerated {
    ...
    public FaceCollapse(RawDynaOrTrackModeler modeler) throws JerboaException {
        ...
        JerboaRuleNode ln2 = new JerboaRuleNode("n2", 2, JerboaOrbit.orbit(-1,-1,3), 3);
        left.add(ln0);
        left.add(ln1);
        left.add(ln2);
        hooks.add(ln0);
        ...
        // -------- RIGHT GRAPH
        JerboaRuleNode rn2 = new JerboaRuleNode("n2", 0, JerboaOrbit.orbit(1,-1,3), 3, new FaceCollapseExprRn2pos());
        right.add(rn2);
;
        // ------- SPECIFIED FEATURE
