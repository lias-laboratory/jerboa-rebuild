...
public class TriPlusVertsFake extends JerboaRebuiltRule {
  ...
  public TriPlusVertsFake(ModelerGenerated modeler) throws JerboaException {
    ...
    JerboaRuleNode rn2 =
        new JerboaRuleNode(
            "n2", 2, JerboaOrbit.orbit(-1, 2, 3), 3, new TriPlusVertsFakeExprRn2pos());
    JerboaRuleNode rn3 = new JerboaRuleNode("n3", 3, JerboaOrbit.orbit(-1, 2, 3), 3);
    JerboaRuleNode rn4 =
        new JerboaRuleNode(
            "n4", 4, JerboaOrbit.orbit(1, 2, 3), 3, new TriPlusVertsFakeExprRn4pos());
    right.add(rn0);
    right.add(rn1);
    right.add(rn2);
    right.add(rn3);
    ...
    public Object compute(
      ...
      return new Vec3(
          Vec3.segmentABByWeight(
              curleftPattern.getNode(0).<fr.ensma.lias.jerboa.embeddings.Vec3>ebd(0), res, 0.5f));
