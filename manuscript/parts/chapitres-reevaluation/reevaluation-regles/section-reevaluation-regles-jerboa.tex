...
\maxime{J'ai tenté une comparaison de notre usage des « non évènements » au
	critère de persistance des références de Bidarra. Est-ce ça te semble correct comme comparaison ? En tout cas, c'est
	une phrase qui peut sauter, je voulais simplement renforcer le côté empirique. } Ce suivi des
évènements annulés répond à une problématique, soulevée par
...
réévaluation, un ensemble d'orbites sur lesquelles réappliquer une opération. %
...
\maxime{ Cette dernière stratégie, c'est celle sur laquelle ont travaillé Tom et
	Victor dans l'interface graphique. En parlant de cette stratégie, j'essaie de
	faire un effet d'annonce avant d'en parler dans la section implantation.
	Est-ce une bonne idée de faire ça ici, ou je l'enlève et n'en parle que dans
	la section implantation ?}
...
illustre plusieurs exemples de réévaluation selon l'échantillon de brins
