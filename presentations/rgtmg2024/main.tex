...
\begin{frame}[c,fragile]
	...
	\begin{minipage}[t][.4\textheight][t]{\textwidth}
		\begin{overlayarea}{\textwidth}{.25\textheight}
			...
			\includegraphics<3-4>[height=.3\textheight]{rule-face-extrusion-compact-n2-n4-highlight}%
			\includegraphics<5-6>[height=.175\textheight]{rule-face-triangulation-3D-n0-highlight}%
			\includegraphics<7-8>[height=.175\textheight]{rule-colour-face}%
		\end{overlayarea}
	\end{minipage}
	\begin{columns}
		\begin{column}{.49\textwidth}
			\begin{minipage}[t][.4\textheight][b]{1.0\linewidth}
				\centering
				\includegraphics<2-3>[width=.45\textheight]{persistent-naming-step-1}%
				\includegraphics<4-5>[width=.45\textheight]{persistent-naming-step-2-alt}%
				\includegraphics<6-7>[width=.45\textheight]{persistent-naming-step-3-alt}%
				...
				\begin{block}{Spécification paramétrique}
					\begin{overlayarea}{\textwidth}{.3\textheight}
						...
						\begin{semiverbatim}
							...
							\only<3->{2-{\color{ForestGreen}extrusion}([1n6], vec)}
							\only<5->{3-{\color{ForestGreen}triangulation}([1n3;2n2])}
							\only<7-8>{4-{\color{ForestGreen}colour}([1n3;2n4;3n0])}
						\end{semiverbatim}
		...
		\begin{column}{.65\textwidth}
			...
			\begin{minipage}[b][.7\textheight][t]{\textwidth}
				\begin{figure}
					...
					\includegraphics<4-5>[width=.8\textwidth]{pn7-reval-short-nolevels-step-4}%
				\end{figure}
			\end{minipage}
		\end{column}
	\end{columns}
	...
	\begin{itemize}
	  ...
	  \begin{itemize}
		...
		\item orbites : histoire complète (suivis et origines) calculée
			  statiquement
	  \end{itemize}
	  \item Réévaluation ajustable via des stratégies
	\end{itemize}
