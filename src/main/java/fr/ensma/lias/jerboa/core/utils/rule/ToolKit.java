...
public final class ToolKit {
   ...
   */
  public static JerboaRuleNode findClosestHook(
      JerboaRuleGenerated rule, JerboaRuleNode node, List<JerboaRuleNode> targets) {
   ...
   */
  public static List<Integer> collectLabelsFromSourceToClosestTarget(
