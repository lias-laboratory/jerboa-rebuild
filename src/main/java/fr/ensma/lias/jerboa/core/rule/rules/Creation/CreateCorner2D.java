...
public class CreateCorner2D extends JerboaRebuiltRule {
    ...
    public CreateCorner2D(ModelerGenerated modeler) throws JerboaException {
        ...
        JerboaRuleNode rn1 = new JerboaRuleNode("n1", 1, JerboaOrbit.orbit(), 3, new CreateCorner2DExprRn1pos());
        ...
        JerboaRuleNode rn6 = new JerboaRuleNode("n6", 6, JerboaOrbit.orbit(), 3, new CreateCorner2DExprRn6pos());
        JerboaRuleNode rn7 = new JerboaRuleNode("n7", 7, JerboaOrbit.orbit(), 3);
        JerboaRuleNode rn8 = new JerboaRuleNode("n8", 8, JerboaOrbit.orbit(), 3, new CreateCorner2DExprRn8pos());
        JerboaRuleNode rn9 = new JerboaRuleNode("n9", 9, JerboaOrbit.orbit(), 3);
        JerboaRuleNode rn10 = new JerboaRuleNode("n10", 10, JerboaOrbit.orbit(), 3, new CreateCorner2DExprRn10pos());
